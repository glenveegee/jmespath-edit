...
(function (global, factory) {
	...
	(global = global || self, global.jmespath = factory());
	...
	var Symbol$1 = root$1.Symbol,
	    ...
	    spreadableSymbol$1 = Symbol$1 ? Symbol$1.isConcatSpreadable : undefined;
	...
	var lodash_frompairs = fromPairs;
	...
	/** Built-in value references. */
	var propertyIsEnumerable$2 = objectProto$3.propertyIsEnumerable;
	...
	var DataView = getNative$1(root$2, 'DataView'),
	    Map$1 = getNative$1(root$2, 'Map'),
	    Promise = getNative$1(root$2, 'Promise'),
	    Set = getNative$1(root$2, 'Set'),
	    WeakMap = getNative$1(root$2, 'WeakMap');
	...
	const functions = {
	  ...
	  // LODASH FUNCTIONS
	  zip: {
	    _func: args => lodash_zip(...args),
	    _signature: [
	      {types: [jmespath.types.TYPE_ARRAY], variadic: true},
	    ]
	  },
	  fromPairs: {
	    _func: args => lodash_frompairs(...args),
	    _signature: [
	      {types: [jmespath.types.TYPE_ARRAY]},
	    ]
	  },
	  toPairs: {
	    _func: args => lodash_topairs(...args),
	    _signature: [
	      {types: [jmespath.types.TYPE_OBJECT]},
	    ]
	  },
	  omit: {
	    _func: args => lodash_omit(...args),
	    _signature: [
	      {types: [jmespath.types.TYPE_OBJECT]},
